...
export function Header() {
  return (
    <header className="flex h-24 items-center px-8 bg-white shadow-lg">
      ...
      <button className="w-44 bg-teal-600 text-white rounded-lg py-2 text-2xl leading-tight hover:bg-teal-500 transition-colors">
        Играть
      </button>
      <button className="ml-auto flex items-center gap-2 text-start text-teal-600 hover:text-teal-500 transition-colors">
        ...
        <div>
          <div className="text-lg leading-tight">SeminMA</div>
